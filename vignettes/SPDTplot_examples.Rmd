...
#Note: Too many facets to display well in RMarkdown, so added last line to make 6 columns
...
## Example: Using the filtered SPDT data set to plot contrasts in Carp Lake vs Backwater or Horsefly strains.
